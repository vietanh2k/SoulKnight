var Range2 = Enemy.extend({
    ...
    initAnimation: function () {
        const duration = 0.6
        const moveDownAnimId = this.load(res.enemy5, '5idle_%01d.png', 0, 3, duration)
        const moveDownAnimId2 = this.load(res.enemy5, '5run_%01d.png', 0, 3, duration)
