var IceBullet = Bullet.extend({
    _map: null,
    speed: 300,


    ctor: function(rule, posLogic, map, direction, dame, rang, speed, duration = 1) {
        this._super(res.iceBullet, rule, posLogic, map, direction, dame, rang, speed);
        this.setScale(1.5)
    ...
    activeBullet: function (target) {
        ...
        target.___freezeEffect = new FreezeEffect(this.duration, target);
        BackgroundLayerInstance.objectView.addEffect(target.___freezeEffect)
    },
