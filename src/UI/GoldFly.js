...
var GoldFly = cc.Node.extend({
    ...
    init:function (pos, des, goldGet) {
        ...
        for(var i=0 ; i<num ; i++){
            ...
            seq = cc.sequence(cc.MoveTo(0.35, p), cc.delayTime(0.45), cc.MoveTo(0.45+r2,des),cc.fadeOut(0),cc.callFunc(()=> this.updateLabel(goldForOne)))
            if(i == num-1){
                seq = cc.sequence(cc.MoveTo(0.35, p), cc.delayTime(0.45), cc.MoveTo(0.45+r2,des),cc.fadeOut(0),cc.callFunc(()=> this.updateLabel(goldForLastOne)))
            }
